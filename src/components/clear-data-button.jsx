  ...
  return (
    <Dialog>
      ...
      <DialogContent closeButtonPosition="right">
        <DialogHeader>
          <DialogTitle className="text-sm font-semibold">Reset local data?</DialogTitle>
          <DialogDescription className="text-xs">
            This removes your stored portfolio, watchlist, preferences, and recent symbols from
            this device. You can&apos;t undo this action.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <DialogClose asChild>
